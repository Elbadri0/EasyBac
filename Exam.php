...
<div id="wrapper-navbar" style="background-color:  #9ad6dd;">
		<div class="navbar object">
            ...
            <div class="top-rated object" style="font-size: 18px">Tous nos exercices et exams |</div>
    		</div>
...
<!--- COURS --------------------------------------------------------------------->	
       ...
       $sql = "SELECT titre ,data,  type_exam ,exam FROM exam ";
          ...
          if (mysqli_num_rows($result) > 0){
              ...
              while($row = $result->fetch_assoc()) {
              		echo "   <figure class='white'>
									<a href='https://melusine.eu.org/syracuse/exemples/gosse/annales99/annales99.pdf-'>
		                            ...
		                            <div id='wrapper-part-info'>		                           
		                            	<div id='part-info'>" . $row["titre"]. "</div>
									</div>
		                        </figure>  ";
